...
Jede Lizenz enthält **5 Mitarbeiter**; das „+3 Mitarbeiter"-Paket (19,99 € netto) kann mehrfach gebucht werden.

## 3. Kundenportal aktivieren
...
## 5. Railway-Variablen setzen (Hub-Service)
```
...
STRIPE_PRICE_SEATS    = price_…          (das „+5 Mitarbeiter"-Paket)
...
- **5 Mitarbeiter** pro Lizenz inklusive; weitere als **5er-Pakete** dazubuchbar (Stammdaten → Abo &amp; Lizenz).
